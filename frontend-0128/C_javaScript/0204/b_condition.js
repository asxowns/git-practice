...
*/
// >> 조건: 보통 비교 연산자를 사용해 표현(동등, 일치, 부등호 - 반환이 boolean 타입으로 반환)
...
//? else문
// : if문과 함께 사용, if문의 주어진 조건이 거짓일 때 실행 코드 블록을 정의
...
// : 변수가 참인지 또는 그 값이 존재하는지를 테스트하기 위해서, 변수 이름 그자체를 사용할 수 있음
